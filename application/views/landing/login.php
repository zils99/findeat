...
<head>
    ...
    <!-- custom css -->
    <link rel="stylesheet" href="<?= base_url('assets/'); ?>css/landing/login.css">
</head>
    ...
    <div style="height: 100vh;" class="container-fluid d-flex justify-content-center">
        <div class="row mt-5">
            <div class="col-lg-5 my-auto">
                <!-- title -->
                <h3 style="font-family: 'Moul', cursive;" class="mb-4">
                    Login
                </h3>

                <?= $this->session->flashdata('registerberhasil'); ?>
                <?= $this->session->flashdata('logingagal'); ?>
                <?= $this->session->flashdata('logoutberhasil'); ?>

                <!-- form -->
                <form method="post" action="<?= base_url('landing/login'); ?>">
                    <div class="mb-3">
                    ...
                    <p style="font-family: 'Moul', cursive; font-size: small;">
                        Don't have account?
                        <a href="<?= base_url('Landing/register') ?>">Register</a>
                    </p>
                    <div class="text-center mt-5">
                        <button type="submit" style="background-color: #203239 !important; border: 0px;" class="btn btn-primary">Login</button>
                    </div>
                </form>
            </div>
            <!-- image -->
